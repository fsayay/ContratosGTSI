...
namespace SGContrato.Controllers
{
    ...
    public class ContratoController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetContrato([FromRoute] int id)
        {
            ...
            contrato = await _context.AC_Contratos.SingleOrDefaultAsync(c => c.ID == id);
        ...
        public async Task<IActionResult> DeleteContrato([FromRoute] int id)
        {
            ...
            var contrato = await _context.AC_Contratos.FindAsync(id);
            if (contrato == null)
            {
                return NotFound();
            }

            _context.AC_Contratos.Remove(contrato);
            await _context.SaveChangesAsync();
