...
namespace SGContrato.Migrations
{
    ...
    [Migration("20200215094840_cambiosContratoNull")]
    partial class cambiosContratoNull
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGContrato.Models.Contrato", b =>
                {
                    ...
                    b.Property<int?>("UserRolrolID");

                    b.Property<int?>("UserRoluserID");
                    ...
                    b.Property<int?>("qn_estadoTransferencia");
                    ...
                    b.Property<string>("txt_codigoTransferencia");
                    ...
                    b.Property<string>("txt_nombreProveedor");
                    ...
                    b.Property<string>("txt_rucProveedor");
                    ...
                    b.HasIndex("UserRoluserID", "UserRolrolID");

                    b.ToTable("AC_Contratos");
                });
            ...
            modelBuilder.Entity("SGContrato.Models.Seccion", b =>
                {
                    ...
                    b.Property<bool>("bol_estadoSeccion");
            ...
            modelBuilder.Entity("SGContrato.Models.Solicitud", b =>
                {
                    ...
                    b.Property<string>("txt_admRecomendado");

                    b.Property<string>("txt_codigoSolicitud");
            ...
            modelBuilder.Entity("SGContrato.Models.Contrato", b =>
                {
                    b.HasOne("SGContrato.Models.UserRol")
                        .WithMany("contratos")
                        .HasForeignKey("UserRoluserID", "UserRolrolID");
                });
            ...
            modelBuilder.Entity("SGContrato.Models.Solicitud", b =>
                {
                    b.HasOne("SGContrato.Models.User")
