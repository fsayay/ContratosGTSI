...
export class ModificacionDialogComponent implements OnInit {
  ...
  constructor( private cs: ContratosService, private sidenavService: SideNavService, private formBuilder: FormBuilder, private dialogRef: MatDialogRef<ModificacionDialogComponent>, @Inject(MAT_DIALOG_DATA) data, private datePipe: DatePipe,  private domSanitizer: DomSanitizer) {
    let seccion;
