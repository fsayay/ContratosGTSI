...
export class GarantiasComponent implements OnInit {
  ...
  constructor(private vencimientoService: VencimientosService, private historialService: HistorialService, private activeModal: NgbActiveModal, private modalService: NgbModal, private http: HttpClient, private contratosService: ContratosService, private garantiasService: GarantiasService, private fb: FormBuilder, private router: Router, private toastr: ToastrService, public dialog: MatDialog) {}
  ...
  openPdfViewer(nombreArchivo: string): void {
